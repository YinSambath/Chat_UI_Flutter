...
class UpdateTrip extends StatefulWidget {
  TripModel? tripData;
  final Function(TripModel tripCallBack) onUpdated;
  UpdateTrip({
    Key? key,
    this.tripData,
...
class _UpdateTripState extends State<UpdateTrip> {
  ...
  @override
  void initState() {
    _title.text = widget.tripData!.title!;
    _note.text = widget.tripData!.note!;
    _seletedDate = widget.tripData!.startDate!;
    _seletedEndDate = widget.tripData!.endDate!;
    _location.text = widget.tripData!.location!;
    _reminder = widget.tripData!.reminder!;
    _progress = widget.tripData!.progress!;
    super.initState();
  }
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (response != null) {
                                    Get.snackbar(
                                        "Successed", "You have updated todo.",
