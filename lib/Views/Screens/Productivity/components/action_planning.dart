...
import 'package:mcircle_project_ui/Views/Screens/Productivity/components/update_action_planning.dart';
import 'package:mcircle_project_ui/Views/Screens/Productivity/components/update_planning.dart';
...
class ActionPlanningList extends StatefulWidget {
  final Function widget3;
  ...
  @override
  State<ActionPlanningList> createState() => _ActionPlanningListState();
}

class _ActionPlanningListState extends State<ActionPlanningList> {
  int _d = 0;
  GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  bool _info = false;
  bool checkbox = false;
  ActionPlanningModel? _actionCallback2;
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ActionPlanningProvider>(context, listen: false)
          .getActionData(widget.planning.sId!);
    });
  }
  callbackMember(int value) {
    setState(() {
      widget.planning.member = value;
    });
  }
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        key: _scaffoldKey,
        endDrawer: (_d == 1)
            ? CreatePlanningAction(planningData: widget.planning)
            : (_d == 2)
                ? UpdatePlanning(
                    planningData: widget.planning,
                    onUpdated: (PlanningModel planningCallBack) {
                      setState(() {
                        widget.planning = planningCallBack;
                      });
                    })
                : (_d == 3)
                    ? UpdateActionPlanning(
                        planningData: widget.planning,
                        actionData: _actionCallback2)
                    : (_d == 4)?AddUser(planningData: widget.planning, countMember: callbackMember): SizedBox(),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    Text(
                                      "${widget.planning.title}",
                                      style: TextStyle(color: kPrimaryColor),
                                    ),
                                    Text(
                                      "Member: ${widget.planning.member}",
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            "Title: " + widget.planning.title!),
                                        SizedBox(height: 3),
                                        Text(
                                          ((widget.planning.startDate != null &&
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                onChanged: (value) async {
                                  String search = value;
                                  String planningId = widget.planning.sId!;
                                  Provider.of<ActionPlanningProvider>(context,
                                          listen: false)
                                      .getSearchAction(planningId, search);
                                },
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      child: Text(
                                                        (_action.assignTo != null || _action.assignTo.firstname != null )?((_action.assignTo.firstname.length >3)?_action.assignTo.firstname.substring(0,3):(_action.assignTo.firstname)):
                                                        "N/A",
                                                      ),
                                                    ),
                                                  ),
