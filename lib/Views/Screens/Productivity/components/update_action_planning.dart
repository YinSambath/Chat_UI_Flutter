...
class UpdateActionPlanning extends StatefulWidget {
  PlanningModel? planningData;
  ActionPlanningModel? actionData;
  ...
  @override
  State<UpdateActionPlanning> createState() => _UpdateActionPlanningState();
}

class _UpdateActionPlanningState extends State<UpdateActionPlanning> {
  ...
  void initState() {
    if (widget.planningData != null) {
      ...
      _startDate.text = widget.actionData!.startDate!;
      _endDate.text = widget.actionData!.endDate!;
      _location.text = widget.actionData!.location!;
      _repeat.text = widget.actionData!.repeat!;
      _endRepeat.text = widget.actionData!.endRepeat!;
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Container(
        width: 400,
        height: (widget.planningData != null) ? 1200 : 1024,
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () async {
                                    ...
                                    if (planningId != null) {
                                      var response = await updateActionPlanning(
                                        planningId,
                                        actionPlanningId,
                                        title,
                                        note,
