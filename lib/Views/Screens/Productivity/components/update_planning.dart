...
class UpdatePlanning extends StatefulWidget {
  final Function(PlanningModel planningCallBack) onUpdated;
...
class _UpdatePlanningState extends State<UpdatePlanning> {
  ...
  void initState() {
    if (widget.planningData != null) {
      ...
      _title.text = widget.planningData!.title!;
      _note.text = widget.planningData!.note!;
      _seletedDate = widget.planningData!.startDate!;
      _seletedEndDate = widget.planningData!.endDate!;
      _location.text = widget.planningData!.location!;
      _reminder = widget.planningData!.reminder!;
      _progress = widget.planningData!.progress!;
    }
    super.initState();
  }
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () async {
                                    ...
                                    var response = await updatePlanning(
                                      planningId,
                                      title,
                                      note,
                                      startDate,
