...
class SeeMore extends StatefulWidget {
  ...
  final int getWidget;
  SeeMore({
    Key? key, required this.back, required this.getWidget,
  }) : super(key: key);
...
class _SeeMoreState extends State<SeeMore> {
  ...
  Widget build(BuildContext context) {
    return (widget.getWidget == 1)?Container(
      width: 1095,
      child: Scaffold(
        key: _scaffoldKey,
