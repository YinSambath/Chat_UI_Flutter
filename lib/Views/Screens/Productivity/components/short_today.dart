...
class ShortToday extends StatefulWidget {
  ShortToday({
    Key? key,
  }) : super(key: key);
  // FolderModel seletedFolder;
  @override
  State<ShortToday> createState() => _ShortTodayState();
}

class _ShortTodayState extends State<ShortToday> {
  int _d = 0;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<TodoProvider>(context, listen: false).getShortData();
      Provider.of<ActionProvider>(context, listen: false).getShortData();
      Provider.of<ActionMeetingProvider>(context, listen: false).getShortData();
      Provider.of<ActionPlanningProvider>(context, listen: false).getShortData();
    });
  }
                  ...
                  Container(
                    child: Row(
                      children: [
                        ...
                        Icon(Icons.double_arrow_rounded, color: kPrimaryColor),
                        SizedBox(width: 10)
                      ],
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Consumer<TodoProvider>(
                          ...
                          if (notifier.state == NotifierState.loading) {
                          ...
                          } else if (notifier.shortData != null && notifier.shortData!.data1 !=null &&
                            ...
                            child = Container(
                              child: ListView.builder(
                                ...
                                itemCount: notifier.shortData!.data1!.length,
