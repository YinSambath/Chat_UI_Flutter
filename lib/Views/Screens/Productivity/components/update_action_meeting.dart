...
class UpdateActionMeeting extends StatefulWidget {
  MeetingModel? meetingData;
  ActionMeetingModel? actionData;
  UpdateActionMeeting({
    Key? key,
    this.meetingData,
    this.actionData,
  ...
  @override
  State<UpdateActionMeeting> createState() => _UpdateActionMeetingState();
}

class _UpdateActionMeetingState extends State<UpdateActionMeeting> {
  ...
  void initState() {
    if (widget.meetingData != null) {
      ...
      _note.text = widget.actionData!.note!;
      _seletedDate = widget.actionData!.startDate!;
      _seletedEndDate = widget.actionData!.endDate!;
      _location.text = widget.actionData!.location!;
      _repeat.text = widget.actionData!.repeat!;
      _endRepeatDate = widget.actionData!.endRepeat!;
      _priority.text = widget.actionData!.priority!;
                  ...
                  children: [
                                ...
                                InkWell(
                                  onTap: () async {
                                    ...
                                    String actionMeetingId =
                                        widget.actionData!.sId!;
                                    if (meetingId != null) {
                                      var response = await updateActionMeeting(
                                        meetingId,
                                        actionMeetingId,
                                        title,
                                        note,
                                      ...
                                      if (response != null) {
                                        Get.snackbar("Successed",
                                            "You have updated action in this meeting list.",
                    ...
                    Consumer<MeetingProvider>(builder: (__, notifier, child) {
                      child = Container(
                        ...
                        child: DropdownButtonFormField2<String>(
                          items: notifier.meetingData?.data!
                              .map<DropdownMenuItem<String>>(
                                  (MeetingModel data) {
