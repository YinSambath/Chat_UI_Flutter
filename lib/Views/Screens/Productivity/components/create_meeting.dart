...
class CreateMeetingAction extends StatefulWidget {
  ...
  @override
  State<CreateMeetingAction> createState() => _CreateMeetingActionState();
}

class _CreateMeetingActionState extends State<CreateMeetingAction> {
...
void getListMeeetingMember() async {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Container(
        width: 400,
        height: (widget.meetingData != null) ? 1300 : 1024,
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                                ...
                                InkWell(
                                  onTap: () async {
                                    ...
                                    String assignTo = _valueMember!;
                                      var response = await createActionMeeting(
                                         meetingId,
                                         title,
                                         note,
                                         startDate,
                    ...
                    SizedBox(height: 18),
                    (widget.meetingData != null)?Container(
                        width: 400,
                        height: 60,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(11),
                    ...
                    (widget.meetingData != null)?SizedBox(height: 18):SizedBox(),
                    Container(
